	...
	<div id="freeze">
		<table class="table table-sm cus-table-borderless">
			<tbody>
				...
				<tr>
					<td><spring:message code="editCustomerOrder.phone" /></td>
					<td><input required="required" readonly="readonly"
						class="form-control form-control-sm"
						ng-model="customerOrder.customer.phone"></td>
				</tr>
				<tr>
					<td><spring:message code="editCustomerOrder.project" /></td>
					<td><select class="form-control form-control-sm"
						...
						ng-options="item.id as item.name for item in customerOrder.customer.customerProjects">
							<option value="">
								<spring:message code="editCustomerOrder.choose" />
							</option>
					</select></td>
				</tr>
			</tbody>
		...
		<table class="table table-bordered table-sm">
			<tbody>
				<tr>
					<th><spring:message code="editCustomerOrder.code" /></th>
					<th><spring:message code="editCustomerOrder.name" /></th>
					<th><spring:message code="editCustomerOrder.quantity" /></th>
					<th><spring:message code="editCustomerOrder.price" /></th>
					<th><spring:message code="editCustomerOrder.unitType" /></th>
					<th><spring:message code="editCustomerOrder.function" /></th>
				</tr>
