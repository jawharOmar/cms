...
<div>
	...
	<sf:form id="add-customer-payment-form" method="POST"
		commandName="customerPayment" onsubmit="addCustomerPayment(event)">
		<table>
			<tbody>
				...
				<tr>
					...
					<td><sf:input type="number" step="any" class="form-control" path="totalPayment" /></td>
...
<script>
	...
	function addCustomerPayment(event) {
		event.preventDefault();
		console.log("addCustomerPayment->fired");

		var data = $("#add-customer-payment-form").serializeJSON();
		console.log("data=", data);
		$
				.ajax({
					type : "POST",
					url : "<c:url value="/customerPayments/add/customer/"/>${customer.id}",
					headers : {
						'X-CSRF-TOKEN' : csrf
					},
